    ...
    return (
        <section className='landing px-40 py-8 flex items-end pb-32'>
            <div className=''>
                ...
                <p className='parag text-white text-2xl w-1/2 mx-auto text-center' >Developer Community, or devcom, is a website wich allows users, who sign-up, to create profiles, share posts and get help from other developers.</p>
